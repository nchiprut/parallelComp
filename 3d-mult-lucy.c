...
#define DIRERCTORY "mult-3d-lucy"
...
int main(int argc, char **argv) {
	...
	MAT_SIZE = 1440/s;
	double *matC =  malloc(MAT_SIZE * MAT_SIZE * sizeof(double));
	double *matA = malloc(MAT_SIZE * MAT_SIZE * sizeof(double));
	double *matB = malloc(MAT_SIZE * MAT_SIZE * sizeof(double));
	double *output =  malloc(MAT_SIZE * MAT_SIZE * sizeof(double));
